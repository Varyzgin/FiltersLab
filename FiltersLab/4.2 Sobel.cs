...
namespace FiltersLab
{
    public class Sobel
    {
        ...
        public static Bitmap Filter(Bitmap inImg)
        {
            ...
            int radiusX = 1;
            int radiusY = 1;
            kernelGx[0, 2] = kernelGx[2, 2] = kernelGy[2, 0] = kernelGy[2, 2] = 1;
            kernelGx[0, 0] = kernelGx[2, 0] = kernelGy[0, 0] = kernelGy[0, 2] = -1;
            kernelGx[1, 2] = kernelGy[2, 1] = 2;
            kernelGx[1, 0] = kernelGy[0, 1] = -2;
